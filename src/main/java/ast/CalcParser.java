...
public class CalcParser extends Parser {
    ...
    public static class SetContext extends ComContext {
        public SetContext(ComContext ctx) {
            copyFrom(ctx);
        }

        public TerminalNode SET() {
            return getToken(CalcParser.SET, 0);
        }
        ...
        public TerminalNode ASSN() {
            return getToken(CalcParser.ASSN, 0);
        }
    ...
    public static class PutContext extends ComContext {
        public PutContext(ComContext ctx) {
            copyFrom(ctx);
        }

        public TerminalNode PUT() {
            return getToken(CalcParser.PUT, 0);
        }
    ...
    public static class OpContext extends ExprContext {
        ...
        public OpContext(ExprContext ctx) {
            copyFrom(ctx);
        }
        ...
        public List<TerminalNode> TIMES() {
            return getTokens(CalcParser.TIMES);
        }
    ...
    public static class ParensContext extends PrimContext {
        public ParensContext(PrimContext ctx) {
            copyFrom(ctx);
        }
    ...
    public static class NumContext extends PrimContext {
        public NumContext(PrimContext ctx) {
            copyFrom(ctx);
        }
    ...
    public static class IdContext extends PrimContext {
        public IdContext(PrimContext ctx) {
            copyFrom(ctx);
        }
